...
public class AppleAndOranges {
    public static void main(String[] args) throws IOException {
       Scanner scan = new Scanner(System.in);
        int houseStartPoint = scan.nextInt();
        int houseEndPoint = scan.nextInt();
        int AppleTree = scan.nextInt();
        int orangeTree = scan.nextInt();
        int NoOfApples = scan.nextInt();
        int NoOfOranges = scan.nextInt();
        
        int applesOnHouse = 0;
        for (int i = 0; i < NoOfApples; i++) {
            int applePosition = AppleTree + scan.nextInt();
            if (applePosition >= houseStartPoint && applePosition <= houseEndPoint) {
                applesOnHouse++;
            }
        }
        ...
        for (int i = 0; i < NoOfOranges; i++) {
            ...
            if (orangePosition >= houseStartPoint && orangePosition <= houseEndPoint) {
                orangesOnHouse++;
            }
        }
